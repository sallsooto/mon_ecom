...
class appProdProjectContainer extends Container
{
    ...
    {
        $this->services['cache.app'] = $instance = new \Symfony\Component\Cache\Adapter\FilesystemAdapter('4ylP2y-gYN', 0, ($this->targetDirs[0].'/pools'));
    ...
    protected function getDoctrine_Dbal_DefaultConnectionService()
    {
        ...
        return $this->services['doctrine.dbal.default_connection'] = ${($_ = isset($this->services['doctrine.dbal.connection_factory']) ? $this->services['doctrine.dbal.connection_factory'] : $this->services['doctrine.dbal.connection_factory'] = new \Doctrine\Bundle\DoctrineBundle\ConnectionFactory(array())) && false ?: '_'}->createConnection(array('driver' => 'pdo_mysql', 'host' => '127.0.0.1', 'port' => '', 'dbname' => 'e_commerce', 'user' => 'root', 'password' => '', 'charset' => 'UTF8', 'driverOptions' => array(1002 => 'SET sql_mode=(SELECT REPLACE(@@sql_mode,\'ONLY_FULL_GROUP_BY\',\'\'))'), 'serverVersion' => 5.0999999999999996447286321199499070644378662109375, 'defaultTableOptions' => array()), new \Doctrine\DBAL\Configuration(), $a, array('enum' => 'string'));
    }
    ...
    protected function getDoctrineCache_Providers_Doctrine_Orm_DefaultMetadataCacheService()
    {
        ...
        $instance->setNamespace('sf_orm_default_0c7d5677bbde25ac13a10c8d20f858e11002933c715a74d6ae06659849c4beae');
    ...
    {
        return $this->services['uri_signer'] = new \Symfony\Component\HttpKernel\UriSigner('STcTdzdJxnPnKiHOXte03hF0cbTHwS2RWgxp6YBf3ZTeOvudQbJ04QL1');
    }
    ...
    protected function getDefaultParameters()
    {
        return array(
            ...
            'secret' => 'STcTdzdJxnPnKiHOXte03hF0cbTHwS2RWgxp6YBf3ZTeOvudQbJ04QL1',
            'ps_caching' => 'CacheMemcache',
            'ps_cache_enable' => false,
            'ps_creation_date' => '2018-12-13',
            'locale' => 'en-US',
            'cookie_key' => 'eIGoqAsHevS8v2PF8d45S6tAoBrSHVjJHwitSq3xXjSKGE5TVtKBsXoC',
            'cookie_iv' => 'QmhKv6ik',
            'new_cookie_key' => 'def00000e6b980a0086f89e4beafe5419f0f86d197f8001254b558fd6aaeeccdb7a3223cee3196c21ab9209f16c97b6bef1c3a448f3e199a216a075b2e850a8071c50213',
            'cache.driver' => 'array',
            ...
            'kernel.secret' => 'STcTdzdJxnPnKiHOXte03hF0cbTHwS2RWgxp6YBf3ZTeOvudQbJ04QL1',
